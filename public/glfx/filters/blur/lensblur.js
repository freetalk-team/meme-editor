...
import { randomShaderFunc, clamp } from '../common.js';
...
export function lensBlur(radius, brightness, angle) {
	...
	gl.lensBlurPrePass = gl.lensBlurPrePass || new Shader(gl, null, '\
	...
	gl.lensBlur0 = gl.lensBlur0 || new Shader(gl, null, common + '\
		void main() {\
			gl_FragColor = sample(delta0);\
		}\
	');
	gl.lensBlur1 = gl.lensBlur1 || new Shader(gl, null, common + '\
		void main() {\
			gl_FragColor = (sample(delta0) + sample(delta1)) * 0.5;\
		}\
	');
	gl.lensBlur2 = gl.lensBlur2 || new Shader(gl, null, common + '\
		void main() {\
